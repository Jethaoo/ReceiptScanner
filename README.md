...
- **Supabase** - Postgres and Storage for optional cloud sync
...
2. Add `supabase.url` and `supabase.anon.key` to **`local.properties`** in the project root (see [SUPABASE_SETUP.md](SUPABASE_SETUP.md)).
